        ...
        appBar: AppBar(
          ...
          leading: Padding(
            ...
            child: FlutterFlowIconButton(
              ...
              onPressed: () async {
                if (_model.onBoardingSliderCurrentIndex > 0) {
                  await _model.onBoardingSliderController?.previousPage(
            ...
            children: [
              ...
              Expanded(
                child: SizedBox(
                  ...
                  child: PageView(
                    controller: _model.onBoardingSliderController ??=
                                      ...
                                      children: [
                                        ...
                                        Align(
                                          ...
                                          child: Padding(
                                            ...
                                            child: wrapWithModel(
                                              model:
                                                  _model.onboardingAnswerModel1,
                                              updateCallback: () =>
                                                  safeSetState(() {}),
                                              child: const OnboardingAnswerWidget(
                                                text: 'Yes',
                                                icon: FaIcon(
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                        ...
                                        child: wrapWithModel(
                                          ...
                                          child: const OnboardingAnswerWidget(
                                            text:
                                                'Discover symptoms of depression',
                                            icon: FaIcon(
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            0.0, 16.0, 0.0, 0.0),
                                        child: wrapWithModel(
                                          model: _model.onboardingAnswerModel10,
                                          updateCallback: () =>
                                              safeSetState(() {}),
                                          child: const OnboardingAnswerWidget(
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                        padding: const EdgeInsetsDirectional.fromSTEB(
                                            0.0, 16.0, 0.0, 0.0),
                                        child: wrapWithModel(
                                          model: _model.onboardingAnswerModel11,
                                          updateCallback: () =>
                                              safeSetState(() {}),
                                          child: const OnboardingAnswerWidget(
                                            text: 'Other',
                  ...
                  child: Padding(
                    ...
                    child: wrapWithModel(
                      ...
                      child: PrimaryButtonWidget(
                        textValue: 'CONTINUE',
                        onTap: () async {
                          if (_model.onBoardingSliderCurrentIndex != 4) {
                            await _model.onBoardingSliderController?.nextPage(
                              duration: const Duration(milliseconds: 300),
                              curve: Curves.ease,
                            );
                            _model.progress = _model.progress! + 0.2;
